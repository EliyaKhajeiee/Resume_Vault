...
import { Check, Mail, ArrowRight, Star, Users, FileText, TrendingUp, Briefcase, Code, Database, BarChart3, Brain, Settings, UserCheck, Eye, Megaphone, DollarSign, PiggyBank } from "lucide-react";
        ...
        <div className="container max-w-6xl mx-auto px-4 text-center">
          <div className="animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-6 max-w-4xl mx-auto leading-relaxed">
              Get hired at elite companies like Google, Meta, and Tesla with 500+ real resumes that actually landed job offers. Stop guessing what works—see exactly what got others hired.
            </p>

            {!isAuthenticated && (
              <p className="text-xl text-blue-600 font-bold mb-12">
                <button
            ...
            {/* Role Categories */}
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4 max-w-6xl mx-auto mb-16 justify-items-center">
